...
- 通知: [scripts/notify.sh](scripts/notify.sh)（alertモード） / [scripts/notify-web.sh](scripts/notify-web.sh)（webモード）
...
<dict>
  ...
  <string>/Users/<you>/batch-timer/templates/notify.html</string>

  <!-- HTMLを直接埋め込みたい場合 -->
  <key>REMINDER_TEMPLATE_HTML</key>
  <string></string>
